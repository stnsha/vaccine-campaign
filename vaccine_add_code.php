...
<body>
 <div class="header" style="position: relative;">
            ...
            <h1 class="headerH1"><img src='../common/img/library2.png'> Add New Vaccine</h1>
	...
	<form id="FormName" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="FormName">
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align='left'>
					<input id='key' class="key" name="vaccine_name" placeholder="Item code or Description" maxlength='200' size='70' onkeydown="return tabOnEnter(this,event)" required />
				</td>
			</tr>
			<tr>
				<td></td><td><input type="submit" name="submit" id="submit" class="form-submit" value="Submit"/></td>
			</tr>
		</table>
	</form>
</fieldset>
