...
$query = "SELECT count(*) FROM  `vaccine_clinic` WHERE `recycle`='1' $option";
...
$query="SELECT * FROM  `vaccine_clinic` WHERE `recycle`='1' $option order by `clinic` $limit";
$result=mysqli_query($conn, $query);
$num = mysqli_num_rows ($result);
?>
<div class="header"><b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
             <h1 class="headerH1"><img src='../common/img/vaccine.png'> List of Clinics (Deactivated)</h1>
             <b class="rbottom"><b class="r4"></b><b class="r3"></b><b class="r2"></b><b class="r1"></b></b>
</div>
<div class='paginator0'><?php if (strpos(strtolower($status_semasa), 'pharmacist') !== false || $status_semasa=='Assistant Branch Manager' || $status_semasa=='Branch Manager' || $status_semasa=='Associate Area Manager' || $status_semasa=='Area Manager' || $vaccine_autho==1) { echo "<a href='vaccine_add_clinic.php'> <img src='../common/img/plus.png' width='18px'></a> | <font size='1'><a href='vaccine_index_clinic.php'><img src='../common/img/star.png' width='18px' style='filter: grayscale(100%);'>Active</a> | <img src='../common/img/star.png'>Deactivated</font>";} ?></div>
<?php
//display page option
if ($pageno == 1) {
...
<a href='vaccine_deactivated_clinic.php' title='Show all'><img src='../common/img/all.png'></a>
...
<fieldset>
	...
	<table border="0" cellpadding="4" cellspacing="1" bgcolor="#EFEFEF" width="100%" class='myTable'>
		<tr>
			<th width='3%'>Num</th>
			<th width='18%'>Clinic Name</th>
			<th width='13%'>Contact</th>
			<th width='7%'>In Charge</th>
			<th width='8%'>Address</th>
			<?php if (strpos(strtolower($status_semasa), 'pharmacist') !== false || $status_semasa=='Assistant Branch Manager' || $status_semasa=='Branch Manager' || $status_semasa=='Associate Area Manager' || $status_semasa=='Area Manager' || $vaccine_autho==1) {echo "<th width='8%'>Edit</th>";} ?>
		</tr>
<?php
if ($num > 0 ) {
$i=0;
...
?>
	<tr>
		...
		<?php if (strpos(strtolower($status_semasa), 'pharmacist') !== false || $status_semasa=='Assistant Branch Manager' || $status_semasa=='Branch Manager' || $status_semasa=='Associate Area Manager' || $status_semasa=='Area Manager' || $vaccine_autho==1) { ?>
		<td align = 'center'><?php echo "<a href=\"vaccine_update_clinic.php?id=$clinic_id\" title = 'Update'><img src='../common/img/edit.png' width='16px'></a> - <a href=\"vaccine_index_clinic.php?id=$clinic_id&r=1\" title = 'Reactivate' onclick=\"return confirm('Are you sure to reactivate this clinic?')\" ><img src='../common/img/loyalty.png' width='16px'></a>"; ?></td>
		<?php } ?>
	</tr>
	<?php
	$i++;
