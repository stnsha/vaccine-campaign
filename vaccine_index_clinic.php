...
<div class="idx-panel">
    <div class="idx-toolbar">
        ...
        <div class="idx-actions">
            ...
            <?php } ?>
            <span class="idx-icon-current" title="Active Clinics"><img src="../common/img/star.png" /> Active</span>
            <span class="idx-sep"></span>
            <a href="vaccine_deactivated_clinic.php" class="idx-icon-link" data-tooltip="Deactivated Clinics"><img src="../common/img/star.png" style="filter:grayscale(100%) !important;" /> Deactivated</a>
            <?php if ($can_edit) { ?>
            <span class="idx-sep"></span>
            <a href="vaccine_export.php" class="idx-icon-link" data-tooltip="Export Clinic List"><img src="../common/img/download.png" /></a>
            <?php } ?>
            <span class="idx-sep"></span>
        ...
        <form id="FormName" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="FormName">
            ...
            <div class="idx-filters">
                ...
                <a href="vaccine_index_clinic.php" class="upd-submit" title="Reset search">Reset</a>
            </div>
        </form>
    </div>
    ...
    <table class="myTable">
        <thead>
            <tr>
                ...
                <th style="width:15%;">Doctor In Charge</th>
                <th>Address</th>
                <th style="width:11%;">Latest Event</th>
                <?php if ($can_edit) { echo "<th style='width:8%;text-align:center !important;'>Actions</th>"; } ?>
            </tr>
        </thead>
        <tbody>
        <?php
        if ($num > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td style="text-align:center !important;color:<?php echo $date_color; ?> !important;"><?php echo htmlspecialchars($latest); ?></td>
                    <?php if ($can_edit) { ?>
                    <td style="text-align:center !important;white-space:nowrap !important;">
                        ...
                        <a href="vaccine_index_clinic.php?id=<?php echo $clinic_id; ?>&d=1" class="tbl-del-link"
                            title="Deactivate" onclick="return confirm('Deactivate this clinic?')">
                            <img src="../common/img/trash.png" width="14px" /> Deactivate
                        </a>
                    </td>
                    <?php } ?>
                </tr>
            ...
            <tr><td colspan="7" style="text-align:center !important;color:#6b7280 !important;padding:20px !important;">No records found.</td></tr>
        <?php } ?>
        </tbody>
    </table>
</div>
